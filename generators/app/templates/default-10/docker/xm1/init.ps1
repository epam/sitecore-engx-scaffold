...
try {
    ...
    & $mkcert -install
    & $mkcert -cert-file <%= solutionX %>-cm.localhost.crt -key-file <%= solutionX %>-cm.localhost.key "<%= solutionX %>-cm.localhost"
    & $mkcert -cert-file <%= solutionX %>-cd.localhost.crt -key-file <%= solutionX %>-cd.localhost.key "<%= solutionX %>-cd.localhost"
	& $mkcert -cert-file <%= solutionX %>-id.localhost.crt -key-file <%= solutionX %>-id.localhost.key "<%= solutionX %>-id.localhost"
}
catch {
...
Add-HostsEntry "<%= solutionX %>-cm.localhost"
Add-HostsEntry "<%= solutionX %>-cd.localhost"
Add-HostsEntry "<%= solutionX %>-id.localhost"
