...
// [assembly: WebActivatorEx.PostApplicationStartMethod(typeof(<%= solutionX %>.Foundation.GlassMapper.App_Start.GlassMapperSc), "Start")]

namespace <%= solutionX %>.Foundation.GlassMapper.App_Start
{
