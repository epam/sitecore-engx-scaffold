    ...
    prompting() {
        ...
        return self
          ...
          .then(function (answers) {
              ...
              var sitecoreVersion = self.options.sitecoreVersion[0].value;

              self.options.vagrantBoxName = sitecoreVersion.vagrantBoxName;

              console.log('For SitecoreVersion: [' + sitecoreVersion.name + '] -> VagrantBoxName: [' + self.options.vagrantBoxName + ']');
