...
class BaseGenerator extends Generator {
  ...
  _updateFileContent(filePath, pipeline) {
    let contents = this.fs.read(filePath);

    contents = pipeline.reduce((contents, f) => f(contents), contents);
...
module.exports = extensions.withConflictExclusions(BaseGenerator);
